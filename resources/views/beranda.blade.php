                ...
                <div class="bg-white rounded-0 p-3 h-100 mt-5">
                    ...
                    <div class="row g-4">
                        @foreach ($gallerys as $gallery)
                            <div class="col-md-3">
                                <a href="{{ asset('storage/img/gallery/'. $gallery->foto) }}" data-lightbox="{{ $gallery->foto }}" class="">
                                    <div class="card">
                                        <div class="card-body">
                                            <img src="{{ asset('storage/img/gallery/'. $gallery->foto) }}" alt="" class="img-fluid ">
        ...
        <div class="row g-5 align-items-center">
            <div class="col-xl-6 wow fadeInLeft" data-wow-delay="0.2s">
                <div class="h-100">
                    ...
                    <div class="mb-5">
                        <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ab, facere commodi facilis, aperiam corporis delectus suscipit numquam praesentium veritatis magnam magni doloribus eligendi iure enim consequatur nostrum architecto quas sint.</p>
                    </div>
                </div>
            </div>
    ...
    <div class="container py-5">
        ...
        <div class="row g-4 justify-content-center">
            ...
            <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.2s">
                <div class="service-item">
                    <div class="service-img">
                        <img src="{{ asset('storage/img/prestasi/'. $prestasi->foto)}}" class="img-fluid rounded-top w-100" alt="">
                    ...
                    <div class="service-content p-4">
                        <div class="service-content-inner">
                            ...
                            <a class="btn btn-primary rounded-pill py-2 px-4" href="{{ route('prestasi.siswa.show', $prestasi->slug) }}">Lihat</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 text-center wow fadeInUp" data-wow-delay="0.2s">
                <a class="btn btn-primary rounded-pill py-3 px-5" href="{{ route('prestasi.sekolah.index') }}">Lihat Prestasi Sekolah</a>
                <a class="btn btn-primary rounded-pill py-3 px-5" href="{{ route('prestasi.siswa.index') }}">Lihat Prestasi Siswa</a>
            </div>
        </div>
    </div>
</div>
