...
<div class="editor-topbar">
    ...
    <form action="{{ route('dashboard.documents.templates.store') }}"
        ...
        <a href="{{ route('dashboard.documents.templates.index') }}" class="tb-btn">
...
<div id="sidebarLeft">
    ...
    <div class="sb-section">
        ...
        <div class="sb-section-body">
            ...
            <button type="button" class="sb-btn outline-warning"
    ...
    <div class="sb-section">
        ...
        <div class="sb-section-body">
            <div class="sb-row">
                <button class="sb-btn" onclick="addShape('rect')"
                        title="Kotak"><i class="bi bi-square"></i> Kotak</button>
                <button class="sb-btn" onclick="addShape('circle')"
                        title="Lingkaran"><i class="bi bi-circle"></i> Ellipse</button>
            </div>
            <div class="sb-row">
                <button class="sb-btn" onclick="addShape('triangle')"
                        title="Segitiga"><i class="bi bi-triangle"></i> Segitiga</button>
                <button class="sb-btn" onclick="addShape('hline')"
                        title="Garis"><i class="bi bi-dash-lg"></i> Garis</button>
            </div>
        </div>
    </div>
    ...
    <div class="sb-section">
        ...
        <div class="sb-section-body">
            <div class="sb-row">
                <button class="sb-btn" onclick="bringForward()">
                    <i class="bi bi-layers-fill"></i> Depan
                </button>
                <button class="sb-btn" onclick="sendBackward()">
                    <i class="bi bi-layers"></i> Belakang
                </button>
            </div>
            <div class="sb-row">
                <button class="sb-btn" onclick="copySelected()">
                    <i class="bi bi-copy"></i> Salin
                </button>
                <button class="sb-btn" onclick="pasteClipboard()">
                    <i class="bi bi-clipboard"></i> Tempel
                </button>
            </div>
            <div class="sb-row">
                <button class="sb-btn" onclick="toggleLock()">
                    <i class="bi bi-lock" id="lockIcon"></i>
                    <span id="lockLabel">Kunci</span>
                </button>
            ...
            <button class="sb-btn" id="btnDeselect">
                ...
                <span class="ctx-shortcut" style="margin-left:auto">Esc</span>
            </button>
            <div class="sb-row">
                <button class="sb-btn" onclick="undo()">
                    <i class="bi bi-arrow-counterclockwise"></i> Undo
                    <span class="ctx-shortcut" style="margin-left:auto">Ctrl+Z</span>
                </button>
                <button class="sb-btn" onclick="redo()">
                    <i class="bi bi-arrow-clockwise"></i> Redo
                    <span class="ctx-shortcut" style="margin-left:auto">Ctrl+Y</span>
                </button>
            </div>
        </div>
    </div>
    ...
    <div class="sb-section">
        <div class="sb-section-head">
            <i class="bi bi-align-center"></i> Perataan
        </div>
        <div class="sb-section-body">
            <div class="sb-row" style="flex-wrap:wrap;gap:3px">
                <button class="sb-btn" style="flex:0 0 auto;padding:5px 8px"
                        onclick="alignObj('left')"    title="Rata Kiri">
                    <i class="bi bi-align-start"></i>
                </button>
                <button class="sb-btn" style="flex:0 0 auto;padding:5px 8px"
                        onclick="alignObj('hcenter')" title="Tengah H">
                    <i class="bi bi-align-center"></i>
                </button>
                <button class="sb-btn" style="flex:0 0 auto;padding:5px 8px"
                        onclick="alignObj('right')"   title="Rata Kanan">
                    <i class="bi bi-align-end"></i>
                </button>
                <button class="sb-btn" style="flex:0 0 auto;padding:5px 8px"
                        onclick="alignObj('top')"     title="Rata Atas">
                    <i class="bi bi-align-top"></i>
                </button>
                <button class="sb-btn" style="flex:0 0 auto;padding:5px 8px"
                        onclick="alignObj('vcenter')" title="Tengah V">
                    <i class="bi bi-align-middle"></i>
                </button>
                <button class="sb-btn" style="flex:0 0 auto;padding:5px 8px"
                        onclick="alignObj('bottom')"  title="Rata Bawah">
                    <i class="bi bi-align-bottom"></i>
                </button>
            </div>
            <div class="sb-row">
                <button class="sb-btn" onclick="distributeObjects('h')">
                    <i class="bi bi-distribute-horizontal"></i> Dist. H
                </button>
                <button class="sb-btn" onclick="distributeObjects('v')">
                    <i class="bi bi-distribute-vertical"></i> Dist. V
                </button>
            </div>
        </div>
    </div>
    ...
    <div class="sb-section" id="formatToolbar">
        <div class="sb-section-head">
            <i class="bi bi-sliders2"></i> Format Objek
        </div>
        <div class="sb-section-body">
            {{-- Font --}}
            <div class="fmt-grid-2">
                <div>
                    ...
                    <select id="fontFamily" class="fmt-select"
                ...
                <div>
                    ...
                    <input type="number" id="fontSize" class="fmt-input"
                           value="14" min="6" max="200"
            ...
            <div class="fmt-btn-row">
                <button id="btnBold"      class="fmt-btn" onclick="toggleBold()"
                        title="Bold"><strong>B</strong></button>
                <button id="btnItalic"    class="fmt-btn" onclick="toggleItalic()"
                        title="Italic"><em>I</em></button>
                <button id="btnUnderline" class="fmt-btn" onclick="toggleUnderline()"
                        title="Underline"><u>U</u></button>
                <button id="btnStrike"    class="fmt-btn" onclick="toggleStrikethrough()"
                        title="Strikethrough"><s>S</s></button>
            </div>

            {{-- Align buttons --}}
            <div class="fmt-btn-row">
                <button id="btnAlignLeft"    class="fmt-btn"
                        onclick="applyFormat('textAlign','left')"
                        title="Rata Kiri"><i class="bi bi-text-left"></i></button>
                <button id="btnAlignCenter"  class="fmt-btn"
                        onclick="applyFormat('textAlign','center')"
                        title="Tengah"><i class="bi bi-text-center"></i></button>
                <button id="btnAlignRight"   class="fmt-btn"
                        onclick="applyFormat('textAlign','right')"
                        title="Rata Kanan"><i class="bi bi-text-right"></i></button>
                <button id="btnAlignJustify" class="fmt-btn"
                        onclick="applyFormat('textAlign','justify')"
                        title="Justify"><i class="bi bi-justify"></i></button>
            </div>
            ...
            <div>
                ...
                <input type="range" class="fmt-range" id="lineHeightSlider"
                       min="10" max="30" value="14"
                       oninput="applyFormat('lineHeight',this.value/10);
            ...
            <div>
                <div class="fmt-range-row">
                    ...
                    <span class="fmt-range-val" id="opacityVal">100</span>
                    <span style="font-size:.68rem;color:var(--text-muted)">%</span>
                </div>
                <input type="range" class="fmt-range" id="objOpacity"
                       min="10" max="100" value="100"
                       oninput="document.getElementById('opacityVal').textContent=this.value;
                                applyOpacity(parseInt(this.value))">
            </div>
            ...
            <div>
                <div class="fmt-range-row">
                    ...
                    <span class="fmt-range-val" id="rotateVal">0</span>
                    <span style="font-size:.68rem;color:var(--text-muted)">°</span>
                </div>
                <input type="range" class="fmt-range" id="objRotate"
                       min="-180" max="180" value="0"
                       oninput="document.getElementById('rotateVal').textContent=this.value;
    ...
    <div class="sb-section">
        <div class="sb-section-head" style="justify-content:space-between">
            ...
            <div style="display:flex;gap:3px">
                <button class="zoom-btn" onclick="addNewPage()"
                        title="Tambah Halaman"><i class="bi bi-plus"></i></button>
                <button class="zoom-btn" onclick="removeCurrentPage()"
                        title="Hapus Halaman"><i class="bi bi-x"></i></button>
            </div>
        </div>
        ...
        <div class="canvas-toolbar">
            ...
            <div class="zoom-row">
                <button class="zoom-btn" onclick="zoomOut()"
                        title="Zoom Out (Ctrl+-)"><i class="bi bi-zoom-out"></i></button>
                <span id="zoomLabel">100%</span>
                <button class="zoom-btn" onclick="zoomIn()"
                        title="Zoom In (Ctrl++)"><i class="bi bi-zoom-in"></i></button>
                <button class="zoom-btn" onclick="zoomReset()"
                        title="Reset Zoom (Ctrl+0)"
                        style="font-size:.7rem;font-weight:700;width:auto;padding:0 6px">1:1</button>
            </div>
            ...
            <label class="ct-switch" title="Toggle Snap">
                <input type="checkbox" id="toggleSnap" checked
                       onchange="setSnapEnabled(this.checked)">
                <i class="bi bi-magnet"></i> Snap
            </label>
            <label class="ct-switch" title="Toggle Margin Guides">
                <input type="checkbox" id="toggleMargin"
                       onchange="toggleMarginGuides(this.checked)">
                <i class="bi bi-border-outer"></i> Margin
            </label>
            <label class="ct-switch" title="Toggle Ruler">
                <input type="checkbox" id="toggleRuler" checked
                       onchange="toggleRulerVis(this.checked)">
            ...
            <div class="coord-bar">
                <span class="coord-item">
                    <i class="bi bi-file-earmark" style="font-size:.65rem"></i>
                    <span id="pageIndicator" class="coord-val">1/1</span>
                </span>
            ...
            <div style="margin-left:auto;display:flex;gap:4px;align-items:center;
                        opacity:0.6;font-size:0.68rem;color:var(--text-muted)">
        ...
        <div id="variablePanel">
            <div class="var-panel-wrap">
                <div class="var-panel-head">
                    ...
                    <small style="font-weight:400;color:var(--text-muted);margin-left:4px">
                        — klik untuk taruh ke canvas
                    </small>
                </div>
...
<script>
/* Fix textBaseline 'alphabetical' → 'alphabetic' (Fabric.js quirk) */
(function () {
    ...
    if (d && d.set) {
        ...
        Object.defineProperty(proto, 'textBaseline', {
            get: d.get,
            set: function (v) {
                orig.call(this, v === 'alphabetical' ? 'alphabetic' : v);
            },
            configurable: true,
