        ...
        <div class="col-lg-7">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('dashboard.documents.categories.store') }}" method="POST"
                        ...
                        <div class="mb-4">
                            ...
                            <div class="form-text">Format: PNG, JPG, SVG. Maks: 2MB</div>
                            @error('logo')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <a href="{{ route('dashboard.documents.categories.index') }}" class="btn btn-outline-secondary">
                                Batal
                            </a>
                        </div>
                    </form>
