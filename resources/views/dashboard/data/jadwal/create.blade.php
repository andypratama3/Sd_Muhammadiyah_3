...
<div class="mb-4 card">
    ...
    <div class="card-body position-relative">
        ...
        <form action="{{ route('dashboard.datasekolah.jadwal.store') }}" method="POST" enctype="multipart/form-data" id="jadwalForm">
            @csrf
            ...
            <div class="mt-4 mb-2 form-group">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered" id="dynamicJadwal">
                        ...
                        <tbody>
                            @foreach (old('jadwal', [[]]) as $index => $oldJadwal)
                            <tr>
                                <td>
                                ...
                                <td>
                                    <input type="time" name="jadwal[{{ $index }}][mulai]" class="mb-2 form-control" placeholder="Mulai" value="{{ $oldJadwal['mulai'] ?? '' }}" required>
                                    <input type="time" name="jadwal[{{ $index }}][selesai]" class="form-control" placeholder="Selesai" value="{{ $oldJadwal['selesai'] ?? '' }}" required>
                                </td>
    ...
    $('#dynamicJadwal').on('click', '.btn-add', function () {
        ...
        const newRow = `
            <tr>
                ...
                <td>
                    <input type="time" name="jadwal[${i}][mulai]" class="mb-2 form-control" placeholder="Mulai" required>
                    <input type="time" name="jadwal[${i}][selesai]" class="form-control" placeholder="Selesai" required>
                </td>
                <td>
                    <label class="mb-1 form-label">Mata Pelajaran</label>
                    <select name="jadwal[${i}][pelajaran_id]" class="mb-2 form-control select2" style="width: 100%;">
                        <option value="">Pilih Mata Pelajaran</option>
                        @foreach ($pelajaran as $item)
                    ...
                    <label class="mt-2 mb-1 form-label">Guru</label>
                    <select name="jadwal[${i}][guru_id]" class="form-control select2" style="width: 100%;">
                        <option value="">Pilih Guru</option>
                        @foreach ($guru as $g)
