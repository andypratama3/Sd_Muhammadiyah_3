...
<div class="mb-4 card">
    ...
    <div class="flex-row py-3 card-header d-flex align-items-center justify-content-between">
        <h6 class="m-0 font-weight-bold text-primary">Tambah Jadwal - Workflow Dinamis</h6>
    </div>
        ...
        <form action="{{ route('dashboard.datasekolah.jadwal.store') }}" method="POST" enctype="multipart/form-data" id="jadwalForm">
            ...
            <div class="form-card">
                <div class="form-title">
                    <i class="fas fa-plus-circle"></i> Tambah Pelajaran ke Jadwal
                </div>
                ...
                <div id="formPelajaran" style="display: none;">
                    ...
                    <div class="form-group-inline">
                        <div>
                            ...
                            <input type="time" id="inputMulai" class="form-control">
                        </div>
                        <div>
                            <label class="form-label required">Waktu Selesai</label>
                            <input type="time" id="inputSelesai" class="form-control">
                        </div>
                    </div>
...
$(document).ready(function () {
    ...
    function renderResult() {
        ...
        $('#totalHari').text(Object.keys(jadwalData).length);
