    ...
    <div class="card-body">
        <form action="{{ route('dashboard.datamaster.judul.pembayaran.update', $judulPembayaran->slug) }}" method="POST">
            ...
            <div class="form-group mt-2 mb-2">
                ...
                <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="name" value="{{ old('name', $judulPembayaran->name) }}" placeholder="Masukan name">
                @error('name')
            ...
            <div class="form-group mt-2 mb-2">
                ...
                <input type="text" class="form-control @error('kode') is-invalid @enderror" name="kode" id="kode" value="{{ old('kode', $judulPembayaran->kode) }}" placeholder="Masukan Kode Pembayaran">
                @error('code')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
