...
@section('title', 'Tambah Struktur Tenaga Pendidikan')
@section('content')
<div class="mb-4 card">
    <div class="flex-row py-3 card-header d-flex align-items-center justify-content-between">
        <h6 class="m-0 font-weight-bold text-primary">Tambah Struktur Tenaga Pendidikan</h6>
    </div>
    <div class="card-body">
        <form action="{{ route('dashboard.datasekolah.struktur.tenaga.pendidikan.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="name" id="name" aria-describedby="Struktur "
                    placeholder="Masukan Nama Struktur">
            </div>
