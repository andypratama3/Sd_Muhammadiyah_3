...
@section('content')
    <div class="card">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" id="date_range" name="date" class="form-control"
                                placeholder="Pilih rentang tanggal (dd-mm-yyyy : dd-mm-yyyy)" value="{{ request('date') }}"
                                autocomplete="off">
                        </div>
        ...
        <!-- Modal Edit Absensi -->
        <div class="modal fade" id="modalEditAbsensi" tabindex="-1" aria-labelledby="modalEditAbsensiLabel"
            aria-hidden="true">
                    ...
                    <form id="formEditAbsensi" method="POST">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3 form-group">
                                ...
                                <input type="number" class="form-control" id="edit_rp_masuk" name="rp_masuk"
                                    step="1000" min="0" />
                            ...
                            <div class="mb-3 form-group">
                                ...
                                <input type="number" class="form-control" id="edit_rp_pulang" name="rp_pulang"
                                    step="1000" min="0" />
                ...
                $(document).ready(function() {
                    ...
                    function loadAbsensiData(id) {
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                // Update form action
                                $('#formEditAbsensi').attr('action',
                                    "{{ route('dashboard.rekap.absensi.update', '') }}" + '/' + id);
                    ...
                    $('#formEditAbsensi').on('submit', function(e) {
                        ...
                        $.ajax({
                            ...
                            dataType: 'json',
                            beforeSend: function() {
                                $('#btn_save').prop('disabled', true).html(
                                    '<i class="fas fa-spinner fa-spin"></i> Menyimpan...');
                            },
                            success: function(response) {
                                $('#btn_save').prop('disabled', false).html(
                                    '<i class="fas fa-save"></i> Simpan Perubahan');
                                ...
                                bootstrap.Modal.getInstance(document.getElementById('modalEditAbsensi'))
                                    .hide();
                                table.ajax.reload();
                            },
                            error: function(xhr) {
