      ...
      <div class="col-lg-12 mb-4">
        ...
        <div class="card">
          <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <h4 class="m-0 font-weight-bold text-primary">Berita</h5>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><img src="{{ asset('storage/img/berita/'.$berita->foto) }}" alt="" srcset="" style="width: 100%; height:90px"></td>
                    <td>
                        <a href="{{ route('dashboard.berita.show', $berita->slug) }}" class="btn btn-dark"><i class="fas fa-info-circle"></i></a>
                        <a href="{{ route('dashboard.berita.edit', $berita->slug) }}" class="btn btn-primary"><i class="fa fa-pen"></i></a>
