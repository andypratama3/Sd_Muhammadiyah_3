...
<body>
    <div class="container py-5">
        <div class="form-container">
            ...
            <form action="{{ route('spmb.store') }}" method="POST" id="ppdbForm" enctype="multipart/form-data">
                @csrf
                <!-- step information -->
                ...
                <div class="step ">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('agama') is-invalid @enderror" id="agama" value="{{ old('agama') }}" />
                            @error('agama')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                ...
                <div class="step">
                    ...
                    <select name="selected_data" name="selected_data" id="selected_data" class="form-control mb-2 form-select" required>
                    ...
                    <div class="row d-none" id="ortu">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('pendidikan_terakhir_ayah') is-invalid @enderror" name="pendidikan_terakhir_ayah" value="{{ old('pendidikan_terakhir_ayah') }}" />
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('pendidikan_terakhir_ibu') is-invalid @enderror" name="pendidikan_terakhir_ibu" value="{{ old('pendidikan_terakhir_ibu') }}" />
                    ...
                    <div class="row d-none" id="wali">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('nama_wali') is-invalid @enderror" value="{{ old('nama_wali') }}" />
                            @error('nama_wali')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('pekerjaan_wali') is-invalid @enderror" value="{{ old('pekerjaan_wali') }}" />
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="tel" class="form-control @error('phone') is-invalid @enderror" value="{{ old('phone') }}" placeholder="08xxxxxxxxxx" />
                            @error('phone')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                ...
                <div class="step">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="file" class="form-control @error('pass_foto') is-invalid @enderror" name="pass_foto" required />
                            @error('pass_foto')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
