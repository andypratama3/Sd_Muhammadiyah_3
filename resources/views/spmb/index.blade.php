        ...
        <div class="form-container">
            ...
            <form action="{{ route('spmb.store') }}" id="form-spmb" method="POST" enctype="multipart/form-data">
                ...
                <div class="step">
                    ...
                    <h6 class="m-3 text-end">Nomor Pendaftaran: {{ sprintf('%03d', $nomor_urut + 1) }}</h6>
                    <div class="row">
                ...
                <div class="step">
                    ...
                    <select name="select_data" id="select_data" class="mb-2 form-control form-select" required>
